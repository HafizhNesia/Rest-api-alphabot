...
const listkey = ["HafizhApi", "HafizhAsia"];
...
router.get('/addapikey', (req, res, next) => {
    ...
    if (apikey != 'HafizhApi') return res.json(loghandler.invalidKey)
                ...
                body: `text_1=${text}&text_2=${text2}&login=OK`,
                    ...
                    if (!e) {
                        ...
                        $(".thumbnail").find("img").each(function() {
                            ...
                            fetch(encodeURI(`https://api.imgbb.com/1/upload?expiration=120&key=871bfe985069c033a0a1897e28f680fd&image=${result}&name=${randomTextNumber}`))
                                .then(response => response.json())
                                .then(data => {
